...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                        .requestMatchers("/public/**", "/categoria/", "/producto/", "/producto/list/**" ).permitAll()
                        .requestMatchers("/producto/list","/valoracion/**", "/usuario/edit/**" ).hasAnyRole("USER","MANAGER", "ADMIN")
                        .requestMatchers("/categoria/**","/producto/**" ).hasAnyRole("MANAGER", "ADMIN")
