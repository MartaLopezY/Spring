...
public class Main {
    ...
    static void inicio() {
        ...
        bdManager = new BdManagerImpl();
        try {
            int regVaciarTabla = bdManager.vaciarTabla();
            System.out.printf("Vaciado previo: %d registros\n", regVaciarTabla);
            int regCargaInicial = bdManager.cargaInicial(empleados);
    ...
    static void alta() {
        ...
        try {
            int cantFilas = bdManager.insertar(new Empleado(id,nombre,salario));
    ...
    static void baja() {
        ...
        Long id = Long.parseLong(teclado.nextLine());
        try {
            int cantFilas = bdManager.borrar(id);
    ...
    static void modificar() {
        ...
        Double salario = Double.parseDouble(teclado.nextLine());
        try {
            int cantFilas = bdManager.actualizar(new Empleado(id, nombre, salario));
    ...
    static void consultarPorSalario() {
        ...
        try {
            resultado = bdManager.consultar(salarMin, salarMax);
